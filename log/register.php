        ...
        <div>
            <div class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm p-4 sm:p-6 lg:p-8 w-[50rem]">
                <form class="space-y-6" action="<?php $_SERVER["PHP_SELF"] ?>" method="post">
                    ...
                    <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Create An Acount</button>
                    <div class="text-sm font-medium text-gray-500 ">
                        Already have an account? <a href="login.php" class="text-blue-700 hover:underline ">Login</a>
                    </div>
                </form>
            </div>
        </div>
